...
package com.kim.gpuimage;

import static com.kim.gpuimage.GPUImageRenderer.CUBE;
...
import com.kim.gpuimage.utils.TextureRotationUtil;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see com.kim.gpuimage.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see com.kim.gpuimage.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.kim.gpuimage.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.kim.gpuimage.GPUImageFilter#onDraw(int,
